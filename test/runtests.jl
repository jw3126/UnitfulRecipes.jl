...
@testset "plot(x,y)" begin
    ...
    @testset "unitformat" begin
        ...
        @test yguide(
            plot(args...; kwargs..., unitformat=(l, u) -> string(u, " is the unit of ", l))
        ...
        @test yguide(plot(args...; kwargs..., unitformat=(", dear ", " esq."))) ==
              "hello, dear s esq."
        @test yguide(plot(args...; kwargs..., unitformat=("well ", ", dear ", " esq."))) ==
...
@testset "code style" begin
    ...
    isformatted = JuliaFormatter.format(root, BlueStyle(); overwrite=false)
    if !isformatted
        msg = """
