...
y = rand(100) * u"km"
plot(
    (0:10:100) * u"hr", rand(11, 4) * u"km"; lab="lines", w=3, palette=:grays, fill=0, α=0.6
)
scatter!(
    y;
    zcolor=abs.(y .- 0.5u"km"),
    m=(:heat, 0.8, Plots.stroke(1, :green)),
    ms=10 * abs.(y .- 0.5u"km") .+ 4u"km",
    lab="grad",
)
